...
func main() {
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan rendah", Persyaratan: "Kartu tanda penduduk/Paspor/Akta pendirian badan usaha", KeteranganPersyaratan: "Kartu tanda penduduk/Paspor/Akta pendirian badan usaha adalah dokumen identitas yang bertujuan untuk mengindentifikasi pemohon atau penanggung jawab terhadap permohonan."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan rendah", Persyaratan: "Surat bukti kepemilikan/Penguasaan lahan", KeteranganPersyaratan: "Surat bukti kepemilikan atau penguasaan lahan adalah dokumen yang dimaksudkan untuk menunjukkan hak hukum seseorang atau badan usaha atas sebidang lahan atau properti tertentu."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan sedang", Persyaratan: "Sertifikat konsultan/Tenaga ahli penyusun andalalin sesuai klasifikasi", KeteranganPersyaratan: "Sertifikat konsultan atau tenaga ahli penyusun andalalin sesuai klasifikasi adalah dokumen yang menunjukkan bahwa seorang profesional atau konsultan memiliki kualifikasi, kompetensi, dan sertifikasi yang sesuai untuk menyusun dokumen Andalalin. Andalalin adalah dokumen yang berisi analisis dampak lingkungan (AMDAL) yang diperlukan dalam perencanaan dan pelaksanaan proyek-proyek yang memiliki potensi dampak terhadap lingkungan."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan sedang", Persyaratan: "Surat bukti kepemilikan/Penguasaan lahan", KeteranganPersyaratan: "Surat bukti kepemilikan atau penguasaan lahan adalah dokumen yang dimaksudkan untuk menunjukkan hak hukum seseorang atau badan usaha atas sebidang lahan atau properti tertentu."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan tinggi", Persyaratan: "Sertifikat konsultan/Tenaga ahli penyusun andalalin sesuai klasifikasi", KeteranganPersyaratan: "Sertifikat konsultan atau tenaga ahli penyusun andalalin sesuai klasifikasi adalah dokumen yang menunjukkan bahwa seorang profesional atau konsultan memiliki kualifikasi, kompetensi, dan sertifikasi yang sesuai untuk menyusun dokumen Andalalin. Andalalin adalah dokumen yang berisi analisis dampak lingkungan (AMDAL) yang diperlukan dalam perencanaan dan pelaksanaan proyek-proyek yang memiliki potensi dampak terhadap lingkungan."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan tinggi", Persyaratan: "Surat bukti kepemilikan/Penguasaan lahan", KeteranganPersyaratan: "Surat bukti kepemilikan atau penguasaan lahan adalah dokumen yang dimaksudkan untuk menunjukkan hak hukum seseorang atau badan usaha atas sebidang lahan atau properti tertentu."})
