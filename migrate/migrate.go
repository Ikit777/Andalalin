...
func main() {
	...
	pusat_kegiatan = append(pusat_kegiatan, models.JenisRencana{Jenis: "Kegiatan perdagangan dan perbelanjaan", Kriteria: "Luas lantai bangunan", Satuan: "m²"})
	pusat_kegiatan = append(pusat_kegiatan, models.JenisRencana{Jenis: "Kegiatan perkantoran", Kriteria: "Luas lantai bangunan", Satuan: "m²"})
	pusat_kegiatan = append(pusat_kegiatan, models.JenisRencana{Jenis: "Kegiatan industri", Kriteria: "Luas lantai bangunan", Satuan: "m²"})
	pusat_kegiatan = append(pusat_kegiatan, models.JenisRencana{Jenis: "Kegiatan pergudangan", Kriteria: "Luas lantai bangunan", Satuan: "m²"})
	pusat_kegiatan = append(pusat_kegiatan, models.JenisRencana{Jenis: "Kawasan pariwisata", Kriteria: "", Satuan: ""})
	pusat_kegiatan = append(pusat_kegiatan, models.JenisRencana{Jenis: "Tempat wisata", Kriteria: "Luas lahan", Satuan: "hektar"})
	...
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Pelabuhan utama", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Pelabuhan pengumpul", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Pelabuhan pengumpan regional", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Pelabuhan pengumpan lokal", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Pelabuhan pengumpan khusus", Kriteria: "Luas lahan", Satuan: "m²"})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Pelabuhan sungai, danau dan penyebrangan", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Bandar udara pengumpul skala pelayanan primer", Kriteria: "Jumlah pengguna pertahun", Satuan: "orang"})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Bandar udara pengumpul skala pelayanan sekunder", Kriteria: "Jumlah pengguna pertahun", Satuan: "orang"})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Bandar udara pengumpul skala pelayanan tersier", Kriteria: "Jumlah pengguna pertahun", Satuan: "orang"})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Bandar udara pengumpan (spoke)", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Terminal penumpang tipe A", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Terminal penumpang tipe B", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Terminal penumpang tipe C", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Terminal angkutan barang", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Terminal peti kemas", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Stasiun kereta api kelar besar", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Stasiun kereta api kelar sedang", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Stasiun kereta api kelar kecil", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Pool kendaraan", Kriteria: "", Satuan: ""})
	infrastruktur = append(infrastruktur, models.JenisRencana{Jenis: "Fasilitas parkir umum", Kriteria: "Besar satuan ruang parkir", Satuan: "SRP"})
	...
	pemukiman = append(pemukiman, models.JenisRencana{Jenis: "Perumahan menengan-atas atau townhouse atau cluster", Kriteria: "Jumlah unit", Satuan: "unit"})
	...
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Stasiun pengisin bahan bakar", Kriteria: "Jumlah dispenser", Satuan: "dispenser"})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Hotel", Kriteria: "Jumlah kamar", Satuan: "kamar"})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Gedung pertemuan", Kriteria: "Luas lantai bangunan", Satuan: "m²"})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Restaurant", Kriteria: "Jumlah tempat duduk", Satuan: "tempat duduk"})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Fasilitan olah raga", Kriteria: "Jumlah kapasitas penonton", Satuan: "orang"})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Kawasan TOD (indoor atau outdoor)", Kriteria: "Luas lantai bangunan", Satuan: "m²"})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Asrama", Kriteria: "Jumlah unit", Satuan: "unit"})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Ruko", Kriteria: "Luas lahan keseluruhan", Satuan: "m²"})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Jalan layang (flyover)", Kriteria: "", Satuan: ""})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Lintas bawas (underpass)", Kriteria: "", Satuan: ""})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Terowongan (tunnel)", Kriteria: "", Satuan: ""})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Jembatan", Kriteria: "", Satuan: ""})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Rest area tipe A", Kriteria: "", Satuan: ""})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Rest area tipe B", Kriteria: "", Satuan: ""})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Rest area tipe C", Kriteria: "", Satuan: ""})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Kegiatan yang menimbukan kepadatan 1500 kendaraan", Kriteria: "", Satuan: ""})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Kegiatan yang menimbukan kepadatan 500 kendaraan", Kriteria: "", Satuan: ""})
	lainnya = append(lainnya, models.JenisRencana{Jenis: "Kegiatan yang menimbukan kepadatan 100 kendaraan", Kriteria: "", Satuan: ""})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan rendah", Persyaratan: "MOU Kerjsa sama", KeteranganPersyaratan: "Apabila ada kerja sama dengan pihak lain, semisal perjanjian sewa lahan, perjanjian penggunaan akses dsb."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan sedang", Persyaratan: "Dokumen hasil analisis dampak lalu lintas", KeteranganPersyaratan: "Analisis dampak lalu lintas adalah proses evaluasi yang digunakan untuk memahami dan memprediksi bagaimana suatu proyek, kebijakan, atau perubahan akan memengaruhi lalu lintas jalan raya. Hasil analisis dampak lalu lintas dapat mencakup berbagai informasi yang diperlukan untuk membuat keputusan tentang pembangunan infrastruktur, rencana lalu lintas, atau perubahan aturan lalu lintas."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan sedang", Persyaratan: "Identitas pemohon atau penanggung jawab", KeteranganPersyaratan: "Identitas pemohon atau penanggung jawab terdiri dari dokumen identitas dan NPWP. dokumen identitas dapat berupa kartu tanda penduduk atau paspor atau akta pendirian badan usaha. Dokumen identitas bertujuan untuk mengindentifikasi pemohon atau penanggung jawab terhadap permohonan.\nSedangkan Nomor Pokok Wajib Pajak (NPWP) adalah nomor identifikasi pajak yang diberikan kepada warga negara atau entitas yang wajib membayar pajak di Indonesia. NPWP adalah bagian penting dari administrasi pajak di Indonesia dan dikeluarkan oleh Direktorat Jenderal Pajak (DJP) yang merupakan lembaga di bawah Kementerian Keuangan Republik Indonesia. NPWP digunakan untuk mengidentifikasi wajib pajak dan melacak pembayaran pajak yang dikenakan."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan sedang", Persyaratan: "Gambar tata letak bangunan (site plan) dan DED Bangunan yang diusulkan", KeteranganPersyaratan: "Tata letak bangunan, atau dalam bahasa Inggris dikenal sebagai site plan, adalah gambar atau diagram yang menunjukkan tata letak fisik bangunan, struktur, dan fasilitas terkait dalam suatu area tertentu. Site plan biasanya digunakan dalam perencanaan konstruksi, pengembangan properti, perizinan bangunan, dan perencanaan tata ruang.\nDokumen Engineering Design (DED) adalah bagian penting dari proses perencanaan dan konstruksi bangunan. DED untuk bangunan yang diusulkan adalah dokumen yang merinci dan mendokumentasikan desain teknik dan teknis dari bangunan yang akan dibangun. DED adalah langkah selanjutnya setelah tahap perencanaan dan perancangan awal, dan sebelum memulai proses konstruksi."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan sedang", Persyaratan: "MOU Kerjsa sama", KeteranganPersyaratan: "Apabila ada kerja sama dengan pihak lain, semisal perjanjian sewa lahan, perjanjian penggunaan akses dsb."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan tinggi", Persyaratan: "Dokumen hasil analisis dampak lalu lintas", KeteranganPersyaratan: "Analisis dampak lalu lintas adalah proses evaluasi yang digunakan untuk memahami dan memprediksi bagaimana suatu proyek, kebijakan, atau perubahan akan memengaruhi lalu lintas jalan raya. Hasil analisis dampak lalu lintas dapat mencakup berbagai informasi yang diperlukan untuk membuat keputusan tentang pembangunan infrastruktur, rencana lalu lintas, atau perubahan aturan lalu lintas."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan tinggi", Persyaratan: "Identitas pemohon atau penanggung jawab", KeteranganPersyaratan: "Identitas pemohon atau penanggung jawab terdiri dari dokumen identitas dan NPWP. dokumen identitas dapat berupa kartu tanda penduduk atau paspor atau akta pendirian badan usaha. Dokumen identitas bertujuan untuk mengindentifikasi pemohon atau penanggung jawab terhadap permohonan.\nSedangkan Nomor Pokok Wajib Pajak (NPWP) adalah nomor identifikasi pajak yang diberikan kepada warga negara atau entitas yang wajib membayar pajak di Indonesia. NPWP adalah bagian penting dari administrasi pajak di Indonesia dan dikeluarkan oleh Direktorat Jenderal Pajak (DJP) yang merupakan lembaga di bawah Kementerian Keuangan Republik Indonesia. NPWP digunakan untuk mengidentifikasi wajib pajak dan melacak pembayaran pajak yang dikenakan."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan tinggi", Persyaratan: "Gambar tata letak bangunan (site plan) dan DED Bangunan yang diusulkan", KeteranganPersyaratan: "Tata letak bangunan, atau dalam bahasa Inggris dikenal sebagai site plan, adalah gambar atau diagram yang menunjukkan tata letak fisik bangunan, struktur, dan fasilitas terkait dalam suatu area tertentu. Site plan biasanya digunakan dalam perencanaan konstruksi, pengembangan properti, perizinan bangunan, dan perencanaan tata ruang.\nDokumen Engineering Design (DED) adalah bagian penting dari proses perencanaan dan konstruksi bangunan. DED untuk bangunan yang diusulkan adalah dokumen yang merinci dan mendokumentasikan desain teknik dan teknis dari bangunan yang akan dibangun. DED adalah langkah selanjutnya setelah tahap perencanaan dan perancangan awal, dan sebelum memulai proses konstruksi."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Bangkitan: "Bangkitan tinggi", Persyaratan: "MOU Kerjsa sama", KeteranganPersyaratan: "Apabila ada kerja sama dengan pihak lain, semisal perjanjian sewa lahan, perjanjian penggunaan akses dsb."})
