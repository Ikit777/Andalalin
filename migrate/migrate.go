...
func main() {
	...
	initializers.DB.Migrator().DropTable(&models.Pengaduan{})
	...
	initializers.DB.AutoMigrate(&models.Pengaduan{})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan rendah", Persyaratan: "Surat permohonan persetujuan andalalin", Tipe: "Pdf", KeteranganPersyaratan: "Surat permohonan persetujuan analisis dampak lalu lintas adalah surat yang digunakan untuk mengajukan permohonan kepada pihak yang berwenang, biasanya pemerintah daerah, untuk mendapatkan persetujuan atau izin terkait dengan rencana atau proyek tertentu. Surat ini harus memuat informasi yang lengkap dan jelas mengenai rencana atau proyek yang diajukan, termasuk tujuan, dampak lingkungan, serta segala persyaratan yang harus dipenuhi."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan rendah", Persyaratan: "Identitas pemohon atau penanggung jawab", Tipe: "Pdf", KeteranganPersyaratan: "Identitas pemohon atau penanggung jawab terdiri dari dokumen identitas dan NPWP. dokumen identitas dapat berupa kartu tanda penduduk atau paspor atau akta pendirian badan usaha. Dokumen identitas bertujuan untuk mengindentifikasi pemohon atau penanggung jawab terhadap permohonan.\nSedangkan Nomor Pokok Wajib Pajak (NPWP) adalah nomor identifikasi pajak yang diberikan kepada warga negara atau entitas yang wajib membayar pajak di Indonesia. NPWP adalah bagian penting dari administrasi pajak di Indonesia dan dikeluarkan oleh Direktorat Jenderal Pajak (DJP) yang merupakan lembaga di bawah Kementerian Keuangan Republik Indonesia. NPWP digunakan untuk mengidentifikasi wajib pajak dan melacak pembayaran pajak yang dikenakan."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan rendah", Persyaratan: "Surat bukti kepemilikan atau Penguasaan lahan", Tipe: "Pdf", KeteranganPersyaratan: "Surat bukti kepemilikan atau penguasaan lahan adalah dokumen yang dimaksudkan untuk menunjukkan hak hukum seseorang atau badan usaha atas sebidang lahan atau properti tertentu."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan rendah", Persyaratan: "Surat kesesuaian tata ruang dan atau izin pemanfaatan ruang", Tipe: "Pdf", KeteranganPersyaratan: "Surat kesesuaian tata ruang dan/atau Izin pemanfaatan ruang adalah dokumen yang diterbitkan oleh pihak berwenang, seperti pemerintah daerah atau instansi terkait, untuk memberikan izin atau persetujuan terkait dengan penggunaan dan pengembangan lahan atau ruang tertentu."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan rendah", Persyaratan: "Gambar tata letak bangunan (site plan) dan DED Bangunan yang diusulkan", Tipe: "Pdf", KeteranganPersyaratan: "Tata letak bangunan, atau dalam bahasa Inggris dikenal sebagai site plan, adalah gambar atau diagram yang menunjukkan tata letak fisik bangunan, struktur, dan fasilitas terkait dalam suatu area tertentu. Site plan biasanya digunakan dalam perencanaan konstruksi, pengembangan properti, perizinan bangunan, dan perencanaan tata ruang.\nDokumen Engineering Design (DED) adalah bagian penting dari proses perencanaan dan konstruksi bangunan. DED untuk bangunan yang diusulkan adalah dokumen yang merinci dan mendokumentasikan desain teknik dan teknis dari bangunan yang akan dibangun. DED adalah langkah selanjutnya setelah tahap perencanaan dan perancangan awal, dan sebelum memulai proses konstruksi."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan rendah", Persyaratan: "Foto kondisi eksisting lapangan terkini", Tipe: "Pdf", KeteranganPersyaratan: "Foto kondisi eksisting lapangan yang terkini adalah gambar-gambar yang menggambarkan kondisi aktual dan terbaru dari lapangan atau area tertentu pada suatu waktu. Foto-foto ini sangat berguna dalam berbagai konteks, termasuk dalam proyek konstruksi, pengembangan properti, pemantauan lingkungan, dan penelitian."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Tidak wajib", Bangkitan: "Bangkitan rendah", Persyaratan: "MOU Kerjsa sama", Tipe: "Pdf", KeteranganPersyaratan: "Apabila ada kerja sama dengan pihak lain, semisal perjanjian sewa lahan, perjanjian penggunaan akses dsb."})

	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan sedang", Persyaratan: "Surat permohonan persetujuan andalalin", Tipe: "Pdf", KeteranganPersyaratan: "Surat permohonan persetujuan analisis dampak lalu lintas adalah surat yang digunakan untuk mengajukan permohonan kepada pihak yang berwenang, biasanya pemerintah daerah, untuk mendapatkan persetujuan atau izin terkait dengan rencana atau proyek tertentu. Surat ini harus memuat informasi yang lengkap dan jelas mengenai rencana atau proyek yang diajukan, termasuk tujuan, dampak lingkungan, serta segala persyaratan yang harus dipenuhi."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan sedang", Persyaratan: "Dokumen hasil analisis dampak lalu lintas (pdf)", Tipe: "Pdf", KeteranganPersyaratan: "Analisis dampak lalu lintas adalah proses evaluasi yang digunakan untuk memahami dan memprediksi bagaimana suatu proyek, kebijakan, atau perubahan akan memengaruhi lalu lintas jalan raya. Hasil analisis dampak lalu lintas dapat mencakup berbagai informasi yang diperlukan untuk membuat keputusan tentang pembangunan infrastruktur, rencana lalu lintas, atau perubahan aturan lalu lintas."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan sedang", Persyaratan: "Dokumen hasil analisis dampak lalu lintas (word)", Tipe: "Word", KeteranganPersyaratan: "Analisis dampak lalu lintas adalah proses evaluasi yang digunakan untuk memahami dan memprediksi bagaimana suatu proyek, kebijakan, atau perubahan akan memengaruhi lalu lintas jalan raya. Hasil analisis dampak lalu lintas dapat mencakup berbagai informasi yang diperlukan untuk membuat keputusan tentang pembangunan infrastruktur, rencana lalu lintas, atau perubahan aturan lalu lintas."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan sedang", Persyaratan: "Identitas pemohon atau penanggung jawab", Tipe: "Pdf", KeteranganPersyaratan: "Identitas pemohon atau penanggung jawab terdiri dari dokumen identitas dan NPWP. dokumen identitas dapat berupa kartu tanda penduduk atau paspor atau akta pendirian badan usaha. Dokumen identitas bertujuan untuk mengindentifikasi pemohon atau penanggung jawab terhadap permohonan.\nSedangkan Nomor Pokok Wajib Pajak (NPWP) adalah nomor identifikasi pajak yang diberikan kepada warga negara atau entitas yang wajib membayar pajak di Indonesia. NPWP adalah bagian penting dari administrasi pajak di Indonesia dan dikeluarkan oleh Direktorat Jenderal Pajak (DJP) yang merupakan lembaga di bawah Kementerian Keuangan Republik Indonesia. NPWP digunakan untuk mengidentifikasi wajib pajak dan melacak pembayaran pajak yang dikenakan."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan sedang", Persyaratan: "Sertifikat konsultan atau tenaga ahli penyusun andalalin sesuai klasifikasi", Tipe: "Pdf", KeteranganPersyaratan: "Sertifikat konsultan atau tenaga ahli penyusun andalalin sesuai klasifikasi adalah dokumen yang menunjukkan bahwa seorang profesional atau konsultan memiliki kualifikasi, kompetensi, dan sertifikasi yang sesuai untuk menyusun dokumen Andalalin. Andalalin adalah dokumen yang berisi analisis dampak lingkungan (AMDAL) yang diperlukan dalam perencanaan dan pelaksanaan proyek-proyek yang memiliki potensi dampak terhadap lingkungan."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan sedang", Persyaratan: "Gambar tata letak bangunan (site plan) dan DED Bangunan yang diusulkan", Tipe: "Pdf", KeteranganPersyaratan: "Tata letak bangunan, atau dalam bahasa Inggris dikenal sebagai site plan, adalah gambar atau diagram yang menunjukkan tata letak fisik bangunan, struktur, dan fasilitas terkait dalam suatu area tertentu. Site plan biasanya digunakan dalam perencanaan konstruksi, pengembangan properti, perizinan bangunan, dan perencanaan tata ruang.\nDokumen Engineering Design (DED) adalah bagian penting dari proses perencanaan dan konstruksi bangunan. DED untuk bangunan yang diusulkan adalah dokumen yang merinci dan mendokumentasikan desain teknik dan teknis dari bangunan yang akan dibangun. DED adalah langkah selanjutnya setelah tahap perencanaan dan perancangan awal, dan sebelum memulai proses konstruksi."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan sedang", Persyaratan: "Foto kondisi eksisting lapangan terkini", Tipe: "Pdf", KeteranganPersyaratan: "Foto kondisi eksisting lapangan yang terkini adalah gambar-gambar yang menggambarkan kondisi aktual dan terbaru dari lapangan atau area tertentu pada suatu waktu. Foto-foto ini sangat berguna dalam berbagai konteks, termasuk dalam proyek konstruksi, pengembangan properti, pemantauan lingkungan, dan penelitian."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Tidak wajib", Bangkitan: "Bangkitan sedang", Persyaratan: "MOU Kerjsa sama", Tipe: "Pdf", KeteranganPersyaratan: "Apabila ada kerja sama dengan pihak lain, semisal perjanjian sewa lahan, perjanjian penggunaan akses dsb."})

	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan tinggi", Persyaratan: "Surat permohonan persetujuan andalalin", Tipe: "Pdf", KeteranganPersyaratan: "Surat permohonan persetujuan analisis dampak lalu lintas adalah surat yang digunakan untuk mengajukan permohonan kepada pihak yang berwenang, biasanya pemerintah daerah, untuk mendapatkan persetujuan atau izin terkait dengan rencana atau proyek tertentu. Surat ini harus memuat informasi yang lengkap dan jelas mengenai rencana atau proyek yang diajukan, termasuk tujuan, dampak lingkungan, serta segala persyaratan yang harus dipenuhi."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan tinggi", Persyaratan: "Dokumen hasil analisis dampak lalu lintas (pdf)", Tipe: "Pdf", KeteranganPersyaratan: "Analisis dampak lalu lintas adalah proses evaluasi yang digunakan untuk memahami dan memprediksi bagaimana suatu proyek, kebijakan, atau perubahan akan memengaruhi lalu lintas jalan raya. Hasil analisis dampak lalu lintas dapat mencakup berbagai informasi yang diperlukan untuk membuat keputusan tentang pembangunan infrastruktur, rencana lalu lintas, atau perubahan aturan lalu lintas."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan tinggi", Persyaratan: "Dokumen hasil analisis dampak lalu lintas (word)", Tipe: "Word", KeteranganPersyaratan: "Analisis dampak lalu lintas adalah proses evaluasi yang digunakan untuk memahami dan memprediksi bagaimana suatu proyek, kebijakan, atau perubahan akan memengaruhi lalu lintas jalan raya. Hasil analisis dampak lalu lintas dapat mencakup berbagai informasi yang diperlukan untuk membuat keputusan tentang pembangunan infrastruktur, rencana lalu lintas, atau perubahan aturan lalu lintas."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan tinggi", Persyaratan: "Identitas pemohon atau penanggung jawab", Tipe: "Pdf", KeteranganPersyaratan: "Identitas pemohon atau penanggung jawab terdiri dari dokumen identitas dan NPWP. dokumen identitas dapat berupa kartu tanda penduduk atau paspor atau akta pendirian badan usaha. Dokumen identitas bertujuan untuk mengindentifikasi pemohon atau penanggung jawab terhadap permohonan.\nSedangkan Nomor Pokok Wajib Pajak (NPWP) adalah nomor identifikasi pajak yang diberikan kepada warga negara atau entitas yang wajib membayar pajak di Indonesia. NPWP adalah bagian penting dari administrasi pajak di Indonesia dan dikeluarkan oleh Direktorat Jenderal Pajak (DJP) yang merupakan lembaga di bawah Kementerian Keuangan Republik Indonesia. NPWP digunakan untuk mengidentifikasi wajib pajak dan melacak pembayaran pajak yang dikenakan."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan tinggi", Persyaratan: "Sertifikat konsultan atau tenaga ahli penyusun andalalin sesuai klasifikasi", Tipe: "Pdf", KeteranganPersyaratan: "Sertifikat konsultan atau tenaga ahli penyusun andalalin sesuai klasifikasi adalah dokumen yang menunjukkan bahwa seorang profesional atau konsultan memiliki kualifikasi, kompetensi, dan sertifikasi yang sesuai untuk menyusun dokumen Andalalin. Andalalin adalah dokumen yang berisi analisis dampak lingkungan (AMDAL) yang diperlukan dalam perencanaan dan pelaksanaan proyek-proyek yang memiliki potensi dampak terhadap lingkungan."})
	...
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan tinggi", Persyaratan: "Gambar tata letak bangunan (site plan) dan DED Bangunan yang diusulkan", Tipe: "Pdf", KeteranganPersyaratan: "Tata letak bangunan, atau dalam bahasa Inggris dikenal sebagai site plan, adalah gambar atau diagram yang menunjukkan tata letak fisik bangunan, struktur, dan fasilitas terkait dalam suatu area tertentu. Site plan biasanya digunakan dalam perencanaan konstruksi, pengembangan properti, perizinan bangunan, dan perencanaan tata ruang.\nDokumen Engineering Design (DED) adalah bagian penting dari proses perencanaan dan konstruksi bangunan. DED untuk bangunan yang diusulkan adalah dokumen yang merinci dan mendokumentasikan desain teknik dan teknis dari bangunan yang akan dibangun. DED adalah langkah selanjutnya setelah tahap perencanaan dan perancangan awal, dan sebelum memulai proses konstruksi."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Wajib", Bangkitan: "Bangkitan tinggi", Persyaratan: "Foto kondisi eksisting lapangan terkini", Tipe: "Pdf", KeteranganPersyaratan: "Foto kondisi eksisting lapangan yang terkini adalah gambar-gambar yang menggambarkan kondisi aktual dan terbaru dari lapangan atau area tertentu pada suatu waktu. Foto-foto ini sangat berguna dalam berbagai konteks, termasuk dalam proyek konstruksi, pengembangan properti, pemantauan lingkungan, dan penelitian."})
	andalalin = append(andalalin, models.PersyaratanAndalalinInput{Kebutuhan: "Tidak wajib", Bangkitan: "Bangkitan tinggi", Persyaratan: "MOU Kerjsa sama", Tipe: "Pdf", KeteranganPersyaratan: "Apabila ada kerja sama dengan pihak lain, semisal perjanjian sewa lahan, perjanjian penggunaan akses dsb."})

	perlalin := []models.PersyaratanPerlalinInput{}
	perlalin = append(perlalin, models.PersyaratanPerlalinInput{Kebutuhan: "Wajib", Persyaratan: "Kartu tanda penduduk", Tipe: "Pdf", KeteranganPersyaratan: "Kartu tanda penduduk adalah dokumen identitas yang bertujuan untuk mengindentifikasi pemohon atau penanggung jawab terhadap permohonan."})
	perlalin = append(perlalin, models.PersyaratanPerlalinInput{Kebutuhan: "Wajib", Persyaratan: "Surat permohonan", Tipe: "Pdf", KeteranganPersyaratan: "Surat permohonan berisi infromasi terkait permohonan yang akan diajukan seperti perlengkapan lalu lintas"})
