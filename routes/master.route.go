...
func (dm *DataMasterRouteController) DataMasterRoute(rg *gin.RouterGroup) {
	...
	router.POST("/tambahpembangunan/:id/:kategori/:rencana/:kriteria/:satuan/:terbilang", middleware.DeserializeUser(), dm.dataMasterController.TambahJenisRencanaPembangunan)
	...
	router.POST("/editpembangunan/:id/:kategori/:rencana/:rencana_new/:kriteria/:satuan/:terbilang", middleware.DeserializeUser(), dm.dataMasterController.EditJenisRencanaPembangunan)
	...
	router.POST("/tambahjenisproyek/:id/:proyek", middleware.DeserializeUser(), dm.dataMasterController.TambahJenisProyek)
	router.POST("/hapusjenisproyek/:id/:proyek", middleware.DeserializeUser(), dm.dataMasterController.HapusJenisProyek)
	router.POST("/editjenisproyek/:id/:proyek/:new_proyek", middleware.DeserializeUser(), dm.dataMasterController.EditJenisProyek)

	router.POST("/tambahjalan/:id", middleware.DeserializeUser(), dm.dataMasterController.TambahJalan)
	router.POST("/hapusjalan/:id/:kode", middleware.DeserializeUser(), dm.dataMasterController.HapusJalan)
	router.POST("/editjalan/:id/:kode/:jalan", middleware.DeserializeUser(), dm.dataMasterController.EditJalan)
}
