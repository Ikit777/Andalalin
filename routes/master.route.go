...
func (dm *DataMasterRouteController) DataMasterRoute(rg *gin.RouterGroup) {
	...
	router.POST("/editpersyaratanandalalin/:id/:persyaratan/:keterangan", middleware.DeserializeUser(), dm.dataMasterController.EditPersyaratanAndalalin)
	...
	router.POST("/editpersyaratanrambulalin/:id/:persyaratan/:keterangan", middleware.DeserializeUser(), dm.dataMasterController.EditPersyaratanRambulalin)
}
