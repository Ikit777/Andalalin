...
type Perlalin struct {
	...
	WaktuAndalalin         string    `gorm:"not null"`
	TanggalAndalalin       string    `gorm:"not null"`
	StatusAndalalin        string    `sql:"type:enum('Cek persyaratan', 'Persyaratan tidak terpenuhi', 'Persyaratan terpenuhi', 'Survey lapangan', 'Laporan survei', 'Menunggu hasil keputusan', 'Tunda pemasangan', 'Segera dilakukan pemasangan', 'Permohonan dibatalkan', 'Permohonan selesai')"`
